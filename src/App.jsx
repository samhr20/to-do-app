        ...
        <form onSubmit={submitHandler}>
          <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
            <input
              ...
              className="flex-1 w-full sm:w-auto p-2 rounded-lg border border-white/30 bg-white/20 text-white placeholder-white/50 focus:outline-none focus:border-white/50"
              required
            />
            <button
              type="submit"
              className="w-full sm:w-auto bg-white/20 hover:bg-white/30 text-white cursor-pointer px-4 py-2 rounded-lg transition-colors"
            >
              ...
              {taskarray.map((t, i) => (
                ...
                >
                  <div className="w-full flex items-center space-x-3">
                    ...
                    />
                    <span
                      className={`text-sm sm:text-base text-white w-full break-words ${
                  ...
                  <div className="flex justify-center items-center gap-2 sm:gap-2.5 flex-col sm:flex-row">
                    <button
